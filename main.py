...
startCounter = 1
# if dwn drone fly put 1, if wn then put 0
...
cv2.createTrackbar("SAT Min","HSV",153,255,empty)
cv2.createTrackbar("SAT Max","HSV",230,255,empty)
cv2.createTrackbar("VALUE Min","HSV",119,255,empty)
cv2.createTrackbar("VALUE Max","HSV",172,255,empty)

cv2.namedWindow("Parameters")
cv2.resizeWindow("Parameters",640,240)
cv2.createTrackbar("Threshold1","Parameters",0,255,empty)
cv2.createTrackbar("Threshold2","Parameters",73,255,empty)
cv2.createTrackbar("Area","Parameters",6000,30000,empty)
...
def display(img):
    ...
    cv2.line(img, (int(frameHeight / 2) - deadZone, 0), (int(frameHeight / 2) - deadZone, frameHeight), (255, 255, 0), 3)
    cv2.line(img, (int(frameHeight / 2) + deadZone, 0), (int(frameHeight / 2) + deadZone, frameHeight), (255, 255, 0), 3)
